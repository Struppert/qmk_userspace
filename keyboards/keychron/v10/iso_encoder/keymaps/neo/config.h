#pragma once
// V10 (STM32L432, 90-Tasten-ISO mit Knob, kein Encoder-Fork nötig) - gleiche
// Werte wie keychron/v3 (identisches EEPROM-Budget dank wear_leveling mit
// 8 KiB Backing / 4 KiB Logical).
