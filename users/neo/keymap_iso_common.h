...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Row1 */ KC_TRNS,
        ...
        /* Row3 */ L3_ESC, S(KC_A), S(KC_S), S(KC_D), S(KC_F), S(KC_G), S(KC_H), S(KC_J), S(KC_K), S(KC_L), S(DE_UDIA), S(DE_ADIA), L3_MO, S(KC_ENT),
    ...
    [_FN] = LAYOUT_ISO(
        ...
        /* Row3 */ SYS_ESC, QK_MACRO_7, QK_MACRO_5, QK_MACRO_3, QK_MACRO_1, DM_PLY2, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, _______, KC_ENT,
        /* Row4 */ KC_LSFT, _______, SYS_MO, KC_NO, KC_NO, KC_NO, MO(_RGB), MO(_SYS), KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_RSFT,
  ...
  [_SYS] = LAYOUT_ISO(
    ...
    /* Row2 */ KC_TAB, DF(_QWERTZ), DF(_NEOQWERTZ1), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
