...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NOTED3] = LAYOUT_ISO(
    ...
    /* R4(13) */ KC_LSFT, KC_DLR,  KC_DOT, KC_PGUP, KC_PGDN, KC_HOME, KC_END,  RM3,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,
  ...
  [_NOTED4] = LAYOUT_ISO(
    ...
    /* R4(13) */ KC_LSFT, KC_NUM, KC_PSLS,KC_P7,  KC_P8,  KC_P9,  KC_PPLS, RM3,    KC_P4,  KC_P5,  KC_P6,  KC_RSFT, KC_UP,
